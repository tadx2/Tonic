...
public extension ChordSymbol {
    ...
    var bestPractice: ChordSymbol? {
        ...
        // 找到该和弦符号最可能对应的理论音程组合
        guard let mostLikelyintervals = chordSymbolToIntervalsMap[body] else { return nil }
        ...
        guard betterSymbolBody != body else { return nil }

        // 将产生的更好的写法与原和弦的根音及其变音记号组合，返回完整的和弦符号
        return ChordSymbol(
            rootNoteLetter: rootNoteLetter,
            rootNoteAcc: rootNoteAcc,
